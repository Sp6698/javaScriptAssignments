...
allCountries.forEach((country) => {
    ...
    let lang =languages.slice(0,-1).join(', ')
    console.log(`The Country Name is '${name}' and capital is '${capital}'
     population of country is:- ${population} 
     languges spoken in the country are ${lang} and ${languages[languages.length-1]}.`)
});
