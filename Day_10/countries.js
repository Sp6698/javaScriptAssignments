...
// // let arr= allCountries.map((country)=>{return (country.languages)})
// allCountries.forEach((country)=>{
//     country.languages.map((lanng)=>countrySet.add(lanng))
// })

// console.log(countrySet)

//Q2.*** Use the countries data to find the 10 most spoken languages:

function countCountries(countryNames,countNo) {
    const countryCounts = {}
    ...
    countryNames.forEach((country) => {
        ...
        country.forEach((singleCountry) => {
            if (countryCounts[singleCountry]) {
                countryCounts[singleCountry]++
            } else {
                countryCounts[singleCountry] = 1
            }
    ...
    result.map((obj, index) => {
        if (index < countNo) {
            arrayMap.set(obj.country, obj.count)
        }
...
console.log('First 10 Most Spoken Langauges ', countCountries(allCountries.map((country) => { return country.languages }),10))
